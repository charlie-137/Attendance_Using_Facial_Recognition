 ...
 // private final Logger logger = new Logger();
  ...
  public synchronized void drawDebug(final Canvas canvas) {
    ...
    for (final Pair<Float, RectF> detection : screenRects) {
      ...
      canvas.drawText(String.valueOf(detection.first), rect.left, rect.top, textPaint);
      borderedText.drawText(canvas, rect.centerX(), rect.centerY(), String.valueOf(detection.first));
    }
  }
...
//      Log.d("tryDrawRect","inside draw "+trackedObjects.size());
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      //Code to display the name of recognized face in the screen above the bounding box
